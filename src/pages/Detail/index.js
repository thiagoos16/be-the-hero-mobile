...
export default function Detail() {
  ...
  const message = 'Olá ONG, estou entrando em contato pois gostaria de ajuda no casox com o valor de x'
  ...
  function sendWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=5592991037733&text=${message}`);
  }
